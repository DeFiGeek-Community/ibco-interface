...
import CalendarInCircle from '../../components/event/countdown-calendar/CalendarInCircle';
import StatisticsInCircle from '../../components/event/statistics/StatisticsInCircle';
